# Project Agent Boundary: ai_interface

## Identity

- Project: `ai_interface`
- Repo path: `/home/ec2-user/work/ai_interface`
- Remote: `https://github.com/ferryhe/ai_interface`
- Worker role: 最上层 agent console / 前台，编排 web_listening、doc_to_md、md_to_rag、rag_to_agent。
