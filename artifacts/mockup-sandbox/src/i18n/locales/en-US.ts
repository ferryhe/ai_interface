export const enUS = {
  translation: {
    ...
    missionCenter: {
      ...
      steps: "{{count}} steps",
      portalStepsLabel: "Mission portal steps",
      stepOrdinal: "Step {{number}}",
      stepActive: "Active",
      stepComplete: "Complete",
      stepPending: "Pending",
      stepIntakeTitle: "Intake",
      stepIntakeDescription: "Capture the task goal and review mode.",
      stepReviewTitle: "Plan review",
      stepReviewDescription: "Check steps, roles, dependencies, and risks.",
      stepApprovalTitle: "Approval points",
      stepApprovalDescription: "Resolve current-mission decisions before execution.",
      stepResultTitle: "Status and result",
      stepResultDescription: "Keep readiness, board, and result draft in the foreground.",
      ...
      resultTitle: "Mission result and readiness",
      resultDescription:
      ...
      portalTokenDescription:
        "Token and public users now enter this same Mission Portal. The token only unlocks mission-scoped and runtime-read APIs guarded as portal-runtime.",
      portalTokenLabel: "Portal access token",
      portalTokenPlaceholder: "portal-token",
      portalTokenSubmit: "Enter Mission Portal",
      portalTokenCheckingShort: "Checking...",
      portalTokenChecking: "Checking Portal token...",
      portalTokenRequired: "Enter a Portal token to continue.",
      portalTokenAuthorized: "Portal token verified for {{versionLabel}}.",
      portalTokenVerifyFailed: "Portal verification returned {{status}}; access remains locked.",
      portalTokenUnexpectedPayload: "Portal verification returned an unexpected payload.",
      portalTokenNotPublished: "Portal is {{publishStatus}}; the public Mission Portal is not open yet.",
      portalTokenRejected: "Portal token was rejected.",
      portalTokenApiUnavailable: "Portal verification API unavailable.",
      portalRuntimeAccessRejected: "Portal runtime access was rejected. Re-enter a valid Portal token.",
      portalTokenState: "Portal access: {{state}}",
    ...
    approvalInbox: {
      ...
      currentMissionTitle: "Current Mission approvals",
      currentMissionDescription:
        "Only pending approval requests tied to this Mission are shown here, so runtime blockers can be resolved without opening Backstage.",
      currentMissionEmpty: "No pending approval requests for this Mission.",
