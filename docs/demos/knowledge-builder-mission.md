...
- Delivery includes the RAG index/query artifacts and traceable intermediate artifacts.
...
5. **Delivery**
   - Source snapshots / converted Markdown / RAG-ready artifacts / query results
...
- a `knowledge_builder` role for RAG ingestion and query artifact generation
...
- Knowledge Builder writes the RAG corpus and emits query-ready artifacts
...
- query results or inspection reports from the RAG artifacts
